...
class FeedsStub(object):
  ...
  def __init__(self, channel):
    ...
    self.GetAllBookmark = channel.unary_unary(
        '/core.feeds.Feeds/GetAllBookmark',
        request_serializer=feeds__pb2.User.SerializeToString,
        response_deserializer=feeds__pb2.FeedList.FromString,
        )
...
def add_FeedsServicer_to_server(servicer, server):
  rpc_method_handlers = {
      ...
      'GetAllBookmark': grpc.unary_unary_rpc_method_handler(
          servicer.GetAllBookmark,
          request_deserializer=feeds__pb2.User.FromString,
          response_serializer=feeds__pb2.FeedList.SerializeToString,
      ),
